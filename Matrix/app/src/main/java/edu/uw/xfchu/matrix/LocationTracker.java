...
public class LocationTracker implements LocationListener {
    ...
    public Location getLocation() {
        try {
            ...
            // getting GPS status
            mlsGPSEnabled = locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER);

            // getting network status
            mlsNetworkEnabled = locationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER);
